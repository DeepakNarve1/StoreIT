      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mb-4 max-w-2xl">
            Finds file and folder names, metadata fields, and{" "}
            <span className="font-medium text-gray-600 dark:text-gray-300">
              full-text inside documents
            </span>{" "}
            (PDF text, Excel/CSV, plain text) plus{" "}
            <span className="font-medium text-gray-600 dark:text-gray-300">
              OCR on images
            </span>{" "}
            after content is indexed (on upload or reindex).
          </p>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Names, metadata, or words inside PDFs, sheets, and images…"
