export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  "file.signature.workflow.started": "Signature workflow started",
  "file.signature.step_signed": "Document signed",
  "file.signature.workflow.cancelled": "Signature workflow cancelled",
